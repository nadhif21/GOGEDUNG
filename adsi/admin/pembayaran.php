...
$sql = "SELECT pemesanan.pemesanan_id, pemesanan.user_id, DATE_FORMAT(pemesanan.tanggal_pemesanan, '%Y-%m-%d') as formatted_date, pemesanan.jumlah_pembayaran, pemesanan.status,nama_gedung, unit.name as user_name 
        FROM pemesanan 
        JOIN unit ON pemesanan.user_id = unit.user_id
        JOIN gedung g ON pemesanan.pemesanan_id = g.pemesanan_id";
