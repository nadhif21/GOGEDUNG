...
$_SESSION['pemesanan_id'] = 2; // Assuming pemesanan_id for dance is 1
...
<body>
    ...
    <section class="containercontent">
        ...
        <img src="../assets/image/gedungolahraga.png" alt="Image 1" class="gallery-image"><br>
        <h2>GEDUNG OLAHRAGA</h2>
        <p>
        Apakah Anda mencari tempat yang cocok untuk menggelar acara olahraga Anda?
         Gedung olahraga kami adalah pilihan yang tepat! Dengan fasilitas yang lengkap
          seperti lapangan olahraga, ruang ganti, dan tempat parkir yang luas, kami siap
           mendukung kegiatan olahraga Anda. Tidak hanya itu, staf kami yang ramah dan
            profesional juga siap membantu menjadikan acara Anda sukses. Hubungi kami
             sekarang untuk informasi lebih lanjut dan booking.
        </p>
